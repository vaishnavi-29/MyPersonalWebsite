...
const socialMediaLinks = [
  ...
  {
    name: "Medium",
    link: "https://vj-codes29.medium.com/",
...
const degrees = {
  degrees: [
    ...
    },
    {
      ...
      subtitle: "12th grade with Maths and Computer Science as majors from Pune",
    ...
    },
    {
      ...
      duration: "2025",
      descriptions: [
        "⚡ //To be updated after starting a university "
      ],
    },
  ],
};
...
const experience = {
  title: "Experience",
  subtitle: "Volunteership, Programs I've Particpated in, Acheivements, Internships and Work ",
  description:
      ...
      },
      {
        ...
        experiences: [
          ...
          },
          {
            ...
            company: "Anitab.org",
            company_url:
            "https://anitab-org.github.io/events/open-source-hack/",
            logo_path: "anitab_logo.png",
          ...
          },
          {
            ...
            company_url: "https://developers.facebook.com/developercircles/open-source-immersion/",
    ...
    experiences: [
      {
        ...
        location: "Pune",
        description:
          "//To be added after I start working",
        color: "#0879bf",
      },
      {
        title: "abc",
